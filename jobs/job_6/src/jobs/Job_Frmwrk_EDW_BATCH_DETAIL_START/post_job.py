"""
Post-job tasks for the Job_Frmwrk_EDW_BATCH_DETAIL_START job.

This module contains functions for the post-job phase of the Job_Frmwrk_EDW_BATCH_DETAIL_START job.
"""
import logging
...
def run_post_job(job_results: Dict[str, Any], config: Dict[str, Any]) -> None:
    """
    Run post-job tasks for the Job_Frmwrk_EDW_BATCH_DETAIL_START job.
